...
export interface Form {
  id: string;
  /**
   * Stable key the code references this form by (e.g. "contact-us").
   */
  slug: string;
  title: string;
  fields?:
...
export interface Header {
  ...
  ctaButtons: {
    ...
    /**
     * Кнопка без ссылки — открывает контактную модалку.
     */
...
export interface Footer {
  ...
  socials?:
    | {
        platform: 'telegram' | 'facebook' | 'youtube' | 'linkedin' | 'instagram' | 'x';
        url: string;
        id?: string | null;
      }[]
    | null;
  newsletter?: {
    heading?: string | null;
    /**
     * Не выбрана — блок подписки на сайте не показывается.
     */
